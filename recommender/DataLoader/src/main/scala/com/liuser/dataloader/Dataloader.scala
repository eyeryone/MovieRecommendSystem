...
object Dataloader {
    val MOVIE_DATA_PATH = "E:\\workspace\\MovieRecommendSystem\\recommender\\DataLoader\\src\\main\\resources\\movies.csv"
    val RATING_DATA_PATH = "E:\\workspace\\MovieRecommendSystem\\recommender\\DataLoader\\src\\main\\resources\\ratings.csv"
    val TAG_DATA_PATH = "E:\\workspace\\MovieRecommendSystem\\recommender\\DataLoader\\src\\main\\resources\\tags.csv"
    ...
    def storeDataInES(movieDF:DataFrame)(implicit eSConfig: ESConfig): Unit = {
        ...
        // . 表示匹配所有 ，+表示多个  \\d 表示匹配数字    .r  表示转成正则类型的
    ...
    def main(args: Array[String]): Unit = {
        ...
        //将处理后的Tag数据和Movie数据融合，产生新的Movie数据
